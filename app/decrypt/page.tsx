...
export default function DecryptPage() {
  ...
  const [statusText, setStatusText] =
    useState('Menunggu kode dan password...');
    ...
    workerRef.current.onmessage = (event: MessageEvent) => {
      ...
      if (type === 'status') {
        ...
        if (fileType === 'text/plain') {
          ...
          setStatusText(`Dekripsi Teks berhasil! Teks "${filename}" ditampilkan.`);
  ...
  const handleFileImport = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      ...
      setInputCode(text);
      setStatusText(`File ${file.name} berhasil di-load. Siap didekripsi.`);
      setStatusType('idle');
    };
    reader.onerror = () => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-16">
        <div className="space-y-8">
          ...
          <div>
            ...
            >
              Masukkan Password (Jika Dibutuhkan)
            </label>
            <div className="relative">
...
py-4 bg-gray-800 border border-gray-700 rounded-lg text-lg focus:border-green-500 focus:ring-green-500 focus:outline-none"
